...
Dla każdego skończonego rozszerzenia $\cialo/\mathcal F$ istnieje inne, skończone i normalne rozszerzenie dla $\mathcal F$, które zawiera $\cialo$, zwane \kolorowo{normalnym domknięciem} $\cialo/\mathcal F$.
Warto wiedzieć.
