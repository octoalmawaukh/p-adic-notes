...
\begin{fakt}
	Jeżeli \prawo{Koblitz\\Ale gdzie?} $k > 0$, to $\sum_{n \ge 0} n^k p^n$ jest wymierne w $\Q_p$.
\end{fakt}
...
Koblitz stwierdza, że problem \prawo{Koblitz?} wymierności liczby $x = \sum_n n!$ pozostaje otwarty w każdym ciele $\Q_p$.
