...
\begin{fakt}
	Pierścień \prawo{Rbrt\\1.1.4} $\Z_p$ nie ma dzielników zera.
\end{fakt}
...
Niech \prawo{Rbrt\\1.1.5} $\mathbb F_p = \Z / p\Z$. Odwzorowanie $\sum_i a_ip^i \mapsto a_0 \pmod p$ jest homomorfizmem pierścieni, \emph{redukcją modulo $p$}.
...
Pierścień \prawo{Rbrt\\1.1.6} $\Z_p$ ma jeden ideał maksymalny, $p \Z_p = \Z_p \setminus \Z_p^\times$.
